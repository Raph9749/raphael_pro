...
const internships: InternshipRow[] = [
  { id: "1", student: "Marie Nguema", company: "MTN Cameroun", position: "Dev. Web Stagiaire", supervisor: "M. Dupont", startDate: "01/02/2026", endDate: "30/04/2026", status: "active" },
  { id: "2", student: "Patrick Mbarga", company: "Orange Cameroun", position: "Data Analyst Jr", supervisor: "Mme. Ondo", startDate: "15/01/2026", endDate: "15/04/2026", status: "active" },
  { id: "3", student: "Celine Mvondo", company: "Societe Generale Cameroun", position: "Assistante Comptable", supervisor: "M. Tchamba", startDate: "01/03/2026", endDate: "31/05/2026", status: "active" },
  { id: "4", student: "Thierry Kamga", company: "Total Energies", position: "Logisticien Stagiaire", supervisor: "Mme. Bello", startDate: "01/01/2026", endDate: "31/03/2026", status: "completed" },
  { id: "5", student: "Aissatou Diallo", company: "Jumia Cameroun", position: "Marketing Digital", supervisor: "M. Simo", startDate: "15/03/2026", endDate: "15/06/2026", status: "active" },
  { id: "6", student: "Samuel Tamba", company: "Bolloree Logistics", position: "Assistant RH", supervisor: "Mme. Fokou", startDate: "01/04/2026", endDate: "30/06/2026", status: "pending" },
  { id: "7", student: "Rose Ekotto", company: "Ecobank", position: "Chargee d'accueil", supervisor: "M. Ngono", startDate: "01/12/2025", endDate: "28/02/2026", status: "completed" },
  { id: "8", student: "Beatrice Ngo", company: "CAMTEL", position: "Tech. Reseau Stagiaire", supervisor: "M. Ateba", startDate: "15/02/2026", endDate: "15/05/2026", status: "active" },
];
